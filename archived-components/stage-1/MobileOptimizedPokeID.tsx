...
interface TypeEffectivenessProps {
  ...
  resistances: ReactNode[];
  immunities: ReactNode[];
}
...
export const MobileInfoBox: React.FC<InfoBoxProps> = ({ title, value, subValue, className = '' }) => (
...
export const MobileTabNav: React.FC<TabNavProps> = ({ tabs, activeTab, onTabChange }) => (
...
export const MobileSection: React.FC<{ title?: string; children: ReactNode; className?: string }> = ({ 
  title, 
  children, 
  className = '' 
}) => (
...
export const MobileTitle: React.FC<TitleProps> = ({ children, size = 'lg' }) => {
  const sizeClasses = {
...
export const MobileTypeEffectiveness: React.FC<TypeEffectivenessProps> = ({ weaknesses, resistances, immunities }) => (
