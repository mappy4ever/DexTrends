...
export default function RegionPage() {
  ...
  const [currentGymLeaderIndex, setCurrentGymLeaderIndex] = useState(0);
  const [showAllGymLeaders, setShowAllGymLeaders] = useState(false);
      ...
      <div className={styles.regionPage}>
        ...
        <section className={styles.starterSection}>
          ...
          <div className={styles.starterGrid}>
            {data.starterPokemon.map((starter, idx) => {
              const types = {
                  ...
                  <div className={styles.leaderInfo}>
                    ...
                    <div className={styles.teamSection}>
                      ...
                      <div className={styles.pokemonTeam}>
                        {currentLeader.team.map((pokemon, idx) => (
                    ...
                    <div className={styles.funFacts}>
                      <h4>Fun Facts</h4>
                      <ul>
                        {currentLeader.funFacts.map((fact, idx) => (
                          <li key={idx}>{fact}</li>
                        ))}
                      </ul>
                    </div>
        ...
        <section className={styles.rareSection}>
          ...
          <div className={styles.rareGrid}>
            {data.rarePokemon.map((pokemon, idx) => (
              <motion.div
                key={pokemon.name}
        ...
        <section className={styles.legendarySection}>
          ...
          <div className={styles.legendaryGrid}>
            {data.legendaryPokemon.map((pokemon) => (
              <motion.div
                key={pokemon.name}
        ...
        <section className={styles.featuresSection}>
          ...
          <div className={styles.featuresList}>
            {data.specialFeatures.map((feature, idx) => (
              <motion.div
                key={idx}
