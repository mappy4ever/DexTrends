    ...
    <>
      ...
      <FullBleedWrapper gradient="pokedex">
        <div className="min-h-screen">
            ...
            >
              ...
              <Link href="/pokedex" className="h-full touch-target group">
                <motion.div
                  ...
                  className="bg-white dark:bg-gray-800/90 rounded-xl sm:rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] transition-shadow duration-150 ease-out p-4 sm:p-5 md:p-6 cursor-pointer h-full flex flex-col min-h-[140px] border border-gray-100 dark:border-gray-700/50"
                >
                  <div className="flex flex-col items-center text-center flex-1">
                    ...
                    <h3 className="text-sm sm:text-base md:text-xl font-semibold text-gray-800 dark:text-white mb-1 sm:mb-2">Pokédex</h3>
              ...
              <Link href="/tcgexpansions" className="h-full touch-target group">
                ...
                >
                  <div className="flex flex-col items-center text-center flex-1">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/20 rounded-full flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-105 transition-transform duration-150">
                      <CardList className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-blue-600 dark:text-blue-400" />
                    </div>
                    <h3 className="text-sm sm:text-base md:text-xl font-semibold text-gray-800 dark:text-white mb-1 sm:mb-2">TCG Cards</h3>
                    <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm hidden sm:block">
              ...
              <Link href="/type-effectiveness" className="h-full touch-target group">
                ...
                >
                  <div className="flex flex-col items-center text-center flex-1">
                    ...
                    <h3 className="text-sm sm:text-base md:text-xl font-semibold text-gray-800 dark:text-white mb-1 sm:mb-2">Battle</h3>
                    <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm hidden sm:block">
              ...
              <Link href="/pokemon/moves" className="h-full touch-target group">
                ...
                >
                  <div className="flex flex-col items-center text-center flex-1">
                    ...
                    <h3 className="text-sm sm:text-base md:text-xl font-semibold text-gray-800 dark:text-white mb-1 sm:mb-2">Resources</h3>
                    <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm hidden sm:block">
          ...
          {/* What's New Section */}
          <section className="max-w-7xl mx-auto px-4 md:px-6 py-12 border-t border-gray-100 dark:border-gray-800">
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-6">What's New</h2>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              {/* Latest Set */}
              <div className="bg-white dark:bg-gray-800/90 rounded-xl p-5 md:p-6 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.06)] transition-shadow duration-150 border border-gray-100 dark:border-gray-700/50">
                <h3 className="font-semibold text-gray-800 dark:text-white mb-2">Latest TCG Set</h3>
                <p className="text-gray-500 dark:text-gray-400 mb-4 text-sm">Paldea Evolved - 279 cards</p>
                <Link href="/tcgexpansions/sv2" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium text-sm inline-flex items-center gap-1 transition-colors duration-150">
              ...
              {/* Popular Pokemon */}
              <div className="bg-white dark:bg-gray-800/90 rounded-xl p-5 md:p-6 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.06)] transition-shadow duration-150 border border-gray-100 dark:border-gray-700/50">
                <h3 className="font-semibold text-gray-800 dark:text-white mb-3">Trending Pokémon</h3>
                <div className="space-y-2">
                  <Link href="/pokedex/6" className="block text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-sm transition-colors duration-150">
                    • Charizard
                  </Link>
                  <Link href="/pokedex/25" className="block text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-sm transition-colors duration-150">
                    • Pikachu
                  </Link>
                  <Link href="/pokedex/282" className="block text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-sm transition-colors duration-150">
                    • Gardevoir
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800/90 rounded-xl p-5 md:p-6 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.06)] transition-shadow duration-150 border border-gray-100 dark:border-gray-700/50">
                ...
                <div className="space-y-2">
                  <Link href="/pokemon/starters" className="block text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-sm transition-colors duration-150">
                    • Starter Pokémon
                  </Link>
                  <Link href="/pokemon/regions" className="block text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-sm transition-colors duration-150">
                    • Explore Regions
                  </Link>
                  <Link href="/fun" className="block text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-sm transition-colors duration-150">
                    • Mini Games
                  </Link>
                </div>
              </div>
