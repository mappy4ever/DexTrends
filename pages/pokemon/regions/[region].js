...
export default function RegionDetailPage() {
  ...
  const currentRegionIndex = regionOrder.indexOf(regionId);
    ...
    <div className="min-h-screen bg-page-bg page-zoom-enter">
      ...
      <div className="fixed top-4 left-4 right-4 z-40 flex justify-between items-center">
        <StyledBackButton 
          text="Back to Regions" 
          onClick={() => router.push('/pokemon/regions')} 
          className="glass-morphism hover:glass-morphism-hover transition-all duration-300 hover:scale-105 hover:shadow-lg"
        />
        ...
        <div className="flex items-center gap-4">
          {regionOrder[currentRegionIndex - 1] && (
            <div className="relative group">
              <button
                ...
                className="glass-morphism dark:glass-morphism-dark rounded-full p-3 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 hover:-translate-y-1"
          ...
          <div className="glass-morphism dark:glass-morphism-dark rounded-full px-6 py-3 shadow-lg">
      ...
      <div className={`sticky top-16 z-30 ${theme === 'dark' ? 'glass-morphism-dark' : 'glass-morphism'} backdrop-blur-md shadow-lg border-b border-gray-200/20 dark:border-gray-800/20`}>
          ...
          <div className="flex items-center justify-center space-x-1 sm:space-x-2 py-3 overflow-x-auto scrollbar-hide">
            <button onClick={() => document.getElementById('region-info').scrollIntoView({ behavior: 'smooth' })} 
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 hover:scale-105 hover:shadow-md ${
                theme === 'dark' ? 'hover:bg-gray-800/50 hover:text-white' : 'hover:bg-gray-100/50 hover:text-gray-900'
              } backdrop-blur-sm`}>
              Overview
            </button>
      ...
      <div className="relative z-10">
        ...
        <section id="professor" className={`section-spacing ${theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-50/50'} backdrop-blur-sm`}>
          <ProfessorShowcase region={region} professor={region.professor} theme={theme} />
        </section>

        {/* Starter Pokémon Section - Well Organized */}
        <section id="starters" className={`section-spacing ${theme === 'dark' ? 'bg-gray-800/50' : 'bg-white/80'} backdrop-blur-sm`}>
          <StarterPokemonShowcase region={region} starters={region.starters} theme={theme} />
        </section>

        {/* Special Pokémon Section (Variants & Legendaries) */}
        <section id="special-pokemon" className={`section-spacing ${theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-50/50'} backdrop-blur-sm`}>
          <SpecialPokemonShowcase region={region} theme={theme} />
        </section>

        {/* Journey Section - Gym Leaders & Elite Four */}
        <section id="journey" className={`section-spacing ${theme === 'dark' ? 'bg-gray-800/50' : 'bg-white/80'} backdrop-blur-sm`}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-16">
              <GymLeaderCarousel 
                region={region} 
                gymLeaders={region.gymLeaders || region.trialCaptains} 
                theme={theme} 
              />
            </div>
            ...
            <div>
              <EliteFourGallery 
                region={region} 
                eliteFour={region.eliteFour || region.islandKahunas} 
        ...
        <section id="explore" className={`section-spacing ${theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-50/50'} backdrop-blur-sm`}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <FadeIn>
              <div className="text-center mb-12">
        ...
        {/* Games Section */}
        <section id="games" className={`section-spacing ${theme === 'dark' ? 'bg-gray-800/50' : 'bg-white/80'} backdrop-blur-sm`}>
          <GameShowcase region={region} theme={theme} />
        </section>

        {/* Evil Teams Section */}
        <section id="evil-teams" className={`section-spacing ${theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-50/50'} backdrop-blur-sm`}>
        ...
        {region.trivia && (
          <section id="trivia" className={`section-spacing ${theme === 'dark' ? 'bg-gray-900/50' : 'bg-gray-50/50'} backdrop-blur-sm`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <FadeIn>
