            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              ...
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full min-h-[44px] px-4 py-2.5 sm:py-3 pl-10 sm:pl-11 text-base bg-stone-100 dark:bg-stone-800 rounded-full focus:outline-none focus:ring-2 focus:ring-amber-500 transition-all touch-manipulation"
                  style={{ fontSize: '16px' }}
                />
