...
async function handler(req, res) {
  ...
  try {
    ...
    if (format === 'prometheus') {
      ...
      return handleJsonFormat(req, res, timeRangeMs);
    }
 ...
 */
function handlePrometheusFormat(req, res) {
  try {
    let metrics = '';
    ...
    if (dashboardData.circuitBreakers.breakers) {
      ...
      dashboardData.circuitBreakers.breakers.forEach(breaker => {
 ...
 */
function handleDashboardFormat(req, res, timeRangeMs) {
  try {
    const dashboardData = monitoring.getDashboardData();
    ...
    const enhancedData = {
      ...
      circuitBreakerDetails: globalRegistry.getMetrics(),
 ...
 * Handle JSON format
 */
function handleJsonFormat(req, res, timeRangeMs) {
  try {
    const data = {
