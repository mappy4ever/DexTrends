...
import { SlideUp } from "./ui/animations/animations";
...
interface PocketExpansionViewerProps {
 ...
 */
export default function PocketExpansionViewer({ expansion }: PocketExpansionViewerProps) {
