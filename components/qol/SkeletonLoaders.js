...
const SkeletonBase = ({ className = '', animate = true, variant = 'rectangular' }) => {
...
export const CardSkeleton = ({ showPrice = true }) => (
...
export const CardGridSkeleton = ({ count = 12, showPrice = true }) => (
...
export const PokemonListGridSkeleton = ({ count = 8 }) => (
...
export const SearchResultsSkeleton = ({ type = 'cards' }) => (
  <div>
    <div className="mb-6">
...
export const PageSkeleton = ({ children, showNav = true }) => (
...
export const SmartSkeleton = ({ 
  ...
  switch (type) {
    case 'card':
      return <CardSkeleton showPrice={showPrice} {...props} />;
    case 'card-grid':
      return <CardGridSkeleton count={count} showPrice={showPrice} {...props} />;
    case 'pokemon-list':
      return <PokemonListGridSkeleton count={count} {...props} />;
    case 'card-detail':
      return <CardDetailSkeleton {...props} />;
    case 'search-results':
      return <SearchResultsSkeleton {...props} />;
    case 'stats-card':
      return <StatsCardSkeleton {...props} />;
    case 'chart':
      return <ChartSkeleton height={height} {...props} />;
    case 'table':
