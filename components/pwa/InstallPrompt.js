...
try {
  ...
  useMobileUtils = () => ({ isMobile: true, isStandalone: false, utils: { isIOS: false, hapticFeedback: () => {} } });
}
import logger from '../../utils/logger';

// Enhanced PWA features component
const PWAFeatures = ({ isVisible }) => {
  return (
...
const InstallPrompt = () => {
  ...
  const [installationAnalytics, setInstallationAnalytics] = useState({
    promptShown: false,
...
export const DesktopInstallButton = () => {
