...
export default function PokeballLoader({ size = 'medium', text = 'Loading...', randomBall = true }) {
  // Start with default pokeball to avoid hydration mismatch
  const [selectedBall, setSelectedBall] = useState(pokeballTypes[0]);
...
export function PokemonLoader({ text = "Catching Pokemon..." }) {
  return (
...
export function CardLoader({ text = "Loading cards..." }) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-blue-50 flex items-center justify-center">
