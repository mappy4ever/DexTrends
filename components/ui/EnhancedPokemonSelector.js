...
export const EnhancedPokemonSelector = ({ 
  isOpen, 
  onClose, 
  onSelect, 
  pokemonList = [],
  ...
  const [sortBy, setSortBy] = useState('id'); // 'id', 'name', 'random'
  ...
  // Enhanced Pokemon selection item with type colors
  const PokemonSelectionItem = ({ pokemon, index }) => {
