...
export default function RegionNavigation({ currentRegion }: RegionNavigationProps) {
  const currentIndex = REGION_ORDER.indexOf(currentRegion.toLowerCase() as Region);
