...
const IPhoneQATests: React.FC = () => {
  const [selectedModel, setSelectedModel] = useState<iPhoneModel>(iPhoneModels[7]); // iPhone 15 by default
  ...
  const getTestDetails = (testId: string): string => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
            ...
            <select
              ...
              onChange={(e) => {
                const model = iPhoneModels.find(m => m.name === e.target.value);
