      ...
      <div className="relative">
        ...
        {showSearchButton && (
          <button
            ...
            className="absolute inset-y-0 right-0 flex items-center pr-3 text-pokemon-blue hover:text-pokemon-red transition-colors disabled:text-stone-400 disabled:cursor-not-allowed"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            ...
            {suggestions.map((suggestion, index) => (
              <div
                ...
                className={`
                  ...
                  ${index === selectedSuggestion ? 'bg-pokemon-blue/10 text-pokemon-blue' : 'text-stone-700 hover:bg-stone-50'}
                `}
              >
