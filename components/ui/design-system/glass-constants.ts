...
// Type overlay colors - for semi-transparent card overlays and backgrounds
// Includes bg (gradient), text (with dark mode), and border colors
export const TYPE_OVERLAYS: Record<string, { bg: string; text: string; border: string }> = {
  grass: {
