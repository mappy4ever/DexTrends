...
const DefaultErrorFallbackContent = ({ 
  ...
  return (
    <div className="min-h-[50vh] flex items-center justify-center p-8">
      <div className="max-w-md w-full bg-white dark:bg-stone-800 rounded-lg shadow-xl p-8 text-center">
        <div className="mb-4">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={onGoHome}
            className="w-full px-4 py-2 bg-stone-200 hover:bg-stone-300 dark:bg-stone-700 dark:hover:bg-stone-600 text-stone-800 dark:text-white font-medium rounded-lg transition-colors"
          >
            Go to Homepage
          </button>
        </div>
