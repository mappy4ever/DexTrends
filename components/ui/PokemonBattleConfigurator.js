...
export const PokemonBattleConfigurator = ({
  playerNumber,
  playerName,
  editingPlayer,
  setEditingPlayer,
...
const IVEVConfigurator = ({ pokemonConfig, setPokemonConfig, selectedPokemon, calculateAllStats }) => {
  return (
    <div className="grid grid-cols-2 gap-4">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-1">
          {Object.entries(pokemonConfig.ivs).map(([stat, value]) => (
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-1">
          {Object.entries(pokemonConfig.evs).map(([stat, value]) => (
...
const BattleStatsDisplay = ({ pokemonConfig, setPokemonConfig, playerColor = 'blue' }) => {
  const colorMap = {
    blue: 'indigo',
    red: 'pink'
  };
  ...
  return (
    <div className={`bg-gradient-to-br from-${gradientColor}-50 to-${gradientColor}-50 rounded-xl p-3`}>
      ...
      <div className="space-y-2">
        {Object.entries(pokemonConfig.stats).map(([stat, value]) => {
