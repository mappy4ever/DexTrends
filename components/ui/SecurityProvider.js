        ...
        if (mutation.type === 'childList') {
          mutation.addedNodes.forEach((node) => {
            if (node.nodeType === Node.ELEMENT_NODE) {
              ...
              if (element.tagName === 'SCRIPT' && !element.src.startsWith(window.location.origin)) {
              ...
              if (element.tagName === 'IFRAME' && !element.src.startsWith(window.location.origin)) {
