...
import { FaChartLine, FaChartBar, FaChartPie, FaTrendingUp, FaTrendingDown, FaUsers, FaEye, FaHeart } from 'react-icons/fa';
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="p-3 bg-purple-100 dark:bg-purple-900 rounded-full">
              <FaTrendingUp className="w-6 h-6 text-purple-600 dark:text-purple-400" />
            </div>
          </div>
        </div>
            ...
            {analyticsData.traffic.searchQueries.map((query, index) => (
              <div key={index} className="flex items-center justify-between">
                ...
                <div className="flex items-center">
                  {query.trend === 'up' && <FaTrendingUp className="w-4 h-4 text-green-500" />}
                  {query.trend === 'down' && <FaTrendingDown className="w-4 h-4 text-red-500" />}
