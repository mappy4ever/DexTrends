...
const getDisplayType = (type, card) => {
...
const getTypeColorClass = (type, displayType) => {
  const typeColorMap = {
  ...
  return typeColorMap[type] || 'bg-gray-200 text-gray-700 border-gray-300';
};
      ...
      <div className="relative w-full">
        ...
        >
            <OptimizedImage 
              ...
              placeholder="blur"
              blurDataURL="data:image/jpeg;base64,"
        ...
        <div className="p-3 space-y-2">
          ...
          <div className="flex items-center justify-center gap-2 text-xs">
            ...
            {showHP && normalizedCard.hp && (
              <span className={`${cardType === "pocket" ? "px-1.5 py-0.5 text-xs" : "px-2 py-1 text-xs"} bg-red-100 text-red-800 rounded-full font-bold`}>
            ...
            {showRarity && normalizedCard.rarity && (
              <span className={`${cardType === "pocket" ? "px-1.5 py-0.5 text-xs" : "px-2 py-1 text-xs"} rounded-full font-bold ${rarityInfo.color}`}>
                {rarityInfo.label}
              </span>
            )}
