...
const EnhancedNavigation = () => {
  ...
  return (
    <>
      ...
      <nav className="hidden lg:flex items-center justify-between bg-white dark:bg-gray-900 shadow-lg border-b border-gray-200 dark:border-gray-700 px-6 py-4">
        {/* Logo Section */}
        ...
        <div className="flex items-center space-x-2">
          {quickActions.map((action) => (
            <button
              ...
              className="flex items-center space-x-2 px-3 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors"
