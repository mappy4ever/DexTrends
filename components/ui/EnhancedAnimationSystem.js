...
import { motion, AnimatePresence, useReducedMotion, useAnimation, useInView, useSpring, useTransform } from 'framer-motion';
...
export const EnhancedAnimationProvider = ({ children }) => {
...
export const EnhancedPageTransition = ({ children, variant = 'fade', className = '' }) => {
...
export const EnhancedLoadingDots = ({ className = '', size = 'md', color = 'currentColor' }) => {
