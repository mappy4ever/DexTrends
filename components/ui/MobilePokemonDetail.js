...
export const MobilePokemonHeader = ({ onBack, onToggleFavorite, isFavorite }) => (
...
export const MobilePokemonHero = ({ pokemon }) => (
...
export const MobilePokemonDetails = ({ pokemon, species }) => {
        ...
        {species && (
          <>
            ...
            <div className="info-card">
              ...
              <div className="info-value">{((species.capture_rate / 255) * 100).toFixed(1)}%</div>
              <div className="info-subvalue">
                {species.capture_rate > 200 ? 'Easy' : 
                 species.capture_rate > 100 ? 'Medium' : 'Hard'}
              </div>
            </div>
          </>
        )}
...
export const MobileStatDisplay = ({ stats }) => {
...
export const MobileTypeEffectiveness = ({ pokemon, typeEffectiveness }) => {
      ...
      {grouped.weak.length > 0 && (
        <div className="effectiveness-group">
          ...
          <div className="effectiveness-badges">
            {grouped.weak.map(({ type, multiplier }) => (
...
// Bottom navigation
export const MobileBottomNavigation = ({ hasPrevious, hasNext, onPrevious, onNext }) => (
...
export const MobileFAB = ({ icon, onClick, label }) => (
  <button
    onClick={onClick}
