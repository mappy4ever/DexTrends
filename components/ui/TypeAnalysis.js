...
const DUAL_TYPE_CALCULATOR = {
  ...
  calculateDualTypeEffectiveness: (attackType, defendType1, defendType2, typeChart) => {
...
export const TypeAnalysisCard = ({ type, onClose }) => {
      ...
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex border-b border-gray-200">
          {[
            ...
            { key: 'matchups', label: 'Matchups', icon: '🎯' }
          ].map(tab => (
            <button
              key={tab.key}
...
export const DualTypeCalculator = () => {
