        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-amber-50 via-white to-amber-50">
          <div className="w-full max-w-md">
            ...
            <div className="glass-medium rounded-2xl p-8 shadow-xl border border-white/20 backdrop-blur-md">
              ...
              {this.state.errorId && (
                <div className="mb-6 p-3 bg-stone-50/50 rounded-lg">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full px-6 py-3 bg-amber-600 text-white rounded-xl hover:bg-amber-700 transition-all duration-200 font-medium shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                >
                  Retry
                </button>
                ...
                <button
                  ...
                  className="w-full px-6 py-3 bg-white/70 text-stone-700 rounded-xl hover:bg-white/90 transition-all duration-200 font-medium border border-stone-200/50 backdrop-blur-sm"
                >
                  Go Home
                </button>
              ...
              {process.env.NODE_ENV === 'development' && this.props.showDetails !== false && this.state.errorInfo && (
                <details className="mt-6 bg-amber-50/50 rounded-lg p-4">
                  <summary className="cursor-pointer font-semibold text-amber-700 mb-2">
                    Development Error Details
                  </summary>
                  <div className="space-y-2">
                    <div>
                      <p className="text-xs font-semibold text-amber-600 mb-1">Error:</p>
                      <pre className="text-xs bg-amber-100/50 p-2 rounded overflow-x-auto whitespace-pre-wrap text-amber-800">
                        {this.state.error.toString()}
                      </pre>
                    </div>
                    <div>
                      <p className="text-xs font-semibold text-amber-600 mb-1">Component Stack:</p>
                      <pre className="text-xs bg-amber-100/50 p-2 rounded overflow-x-auto whitespace-pre-wrap text-amber-800">
