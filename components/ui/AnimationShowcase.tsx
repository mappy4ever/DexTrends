...
interface SampleCard {
  id: number;
  name: string;
  rarity: 'common' | 'holo' | 'ultra' | 'secret';
}
            ...
            <div className="bg-white dark:bg-stone-800 p-6 rounded-lg shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <AnimatedToggle
                  ...
                  onChange={setEnableMicroInteractions}
                ...
                <div className="bg-white dark:bg-stone-800 p-6 rounded-lg shadow-lg space-y-4">
                  ...
                  <div className="space-y-2">
                    {(['primary', 'secondary', 'success', 'danger'] as ButtonVariant[]).map((variant) => (
                      <AnimatedButton key={variant} variant={variant} className="w-full capitalize">
                        {variant} Button
                      </AnimatedButton>
                    ))}
                  </div>
                ...
                <div className="bg-white dark:bg-stone-800 p-6 rounded-lg shadow-lg">
                  ...
                  <div className="flex items-center justify-around">
                    {(['sm', 'md', 'lg'] as LoadingSize[]).map((size) => (
                      <EnhancedLoadingDots key={size} size={size} />
                    ))}
                  </div>
                </div>
              </ScrollReveal>
