...
import { CardHover } from '../animations/animations'; // Assuming CardHover is needed for grid
...
interface PokemonCardItemProps {
  ...
  getSpriteFn: (pokemon: Pokemon) => string;
}

const PokemonCardItem = memo(({
  poke,
  isFavorite,
  viewMode,
  cardSize,
    ...
    return (
      ...
      >
        ...
        <div className="relative flex items-center justify-center w-full mb-3 z-10 cursor-pointer">
          ...
          <Image
            src={getSpriteFn(poke)} // Use poke object
            alt={poke.name}
...
const areEqual = (prevProps: PokemonCardItemProps, nextProps: PokemonCardItemProps) => {
  return (
...
export default memo(PokemonCardItem, areEqual);
