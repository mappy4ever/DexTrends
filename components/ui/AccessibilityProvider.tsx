  ...
  return (
    <AccessibilityContext.Provider value={contextValue}>
      ...
      <a
        ...
        className="skip-link sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-amber-500 focus:text-white focus:rounded"
      >
        Skip to main content
      </a>
