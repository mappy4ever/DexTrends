...
const GameTimeline: React.FC<GameTimelineProps> = ({ games, theme }) => {
  ...
  // Sort by date
  allGames.sort((a, b) => new Date(a.releaseDate).getTime() - new Date(b.releaseDate).getTime());
