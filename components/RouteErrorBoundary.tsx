    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[400px] flex items-center justify-center p-8">
          <div className="max-w-md w-full bg-white dark:bg-stone-800 rounded-lg shadow-xl p-6 text-center">
            <div className="mb-4">
              <svg
            ...
            {process.env.NODE_ENV === 'development' && this.state.error && (
              <details className="text-left mb-4">
                ...
                <div className="mt-2 p-3 bg-stone-100 dark:bg-stone-900 rounded text-xs overflow-auto max-h-48">
            ...
            <div className="flex gap-3 justify-center">
              ...
              <button
                ...
                className="px-4 py-2 bg-stone-200 dark:bg-stone-700 text-stone-700 dark:text-stone-300 rounded-lg hover:bg-stone-300 dark:hover:bg-stone-600 transition-colors"
              >
                Go Home
              </button>
            </div>
