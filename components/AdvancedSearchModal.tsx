      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-3">
            <button
              onClick={onClose}
              className="px-6 py-2 border border-stone-300 dark:border-stone-600 text-stone-700 dark:text-stone-300 rounded-md hover:bg-stone-50 dark:hover:bg-stone-700"
            >
              Cancel
            </button>
            <button
              ...
              disabled={isLoading}
              className="px-6 py-2 bg-amber-600 text-white rounded-md hover:bg-amber-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {isLoading && (
          ...
          <div className="border-t border-stone-200 dark:border-stone-700 pt-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 max-h-96 overflow-y-auto">
              {results.slice(0, 24).map(card => (
                <div key={card.id} className="border border-stone-200 dark:border-stone-700 rounded-lg p-2">
                  <img
