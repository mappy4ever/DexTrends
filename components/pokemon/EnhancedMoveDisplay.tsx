...
export const EnhancedMoveDisplay: React.FC<EnhancedMoveDisplayProps> = ({ moveName, className }) => {
  ...
  const typeHex = moveData.type ? typeColors[moveData.type.toLowerCase()] : null;
  const typeColor = typeHex ? '' : 'bg-gray-600';
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <span 
            className={cn("px-2 py-1 rounded text-xs font-medium text-white", typeColor)}
