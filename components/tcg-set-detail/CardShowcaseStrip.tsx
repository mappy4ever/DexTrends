  ...
  return (
    ...
    >
      ...
      >
        ...
        {price > 100 && (
          <div className="absolute top-2 right-2" role="img" aria-label="Premium card">
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-2 right-2 min-w-[44px] min-h-[44px] w-11 h-11 rounded-full bg-stone-100 dark:bg-stone-800 flex items-center justify-center hover:bg-stone-200 dark:hover:bg-stone-700 transition-colors"
      >
        <svg className="w-5 h-5 text-stone-600 dark:text-stone-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
