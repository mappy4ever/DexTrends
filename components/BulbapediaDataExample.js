...
export const GymLeaderDisplay = ({ leaderName }) => {
...
export const TCGRarityDisplay = () => {
  ...
  const fetchRarities = async () => {
    ...
    if (data) {
      const rarityImages = data.filter(img => 
...
export const CategoryBrowser = ({ categoryName = "Generation I Pokémon" }) => {
  const { data, loading, error } = useBulbapediaQuery(
    'category',
