    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <img 
          ...
          onLoad={(e) => console.log('Region map loaded!', e.target.src)}
          onError={(e) => {
            console.error('Region map failed!', e.target.src);
            setMapError(true);
          }}
        />
