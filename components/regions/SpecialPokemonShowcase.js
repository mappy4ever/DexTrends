...
const SpecialPokemonShowcase = ({ region, theme }) => {
  ...
  const pokemonList = activeTab === 'variants' ? activeData?.variants : activeData?.legendaries;
                  ...
                  <SlideUp key={pokemon.id} delay={index * 0.05}>
                    ...
                    >
                      ...
                      <div className="relative h-32 sm:h-40 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800">
                        ...
                        {((activeTab === 'variants' && pokemon.isLegendary) || (activeTab === 'legendaries' && pokemon.isVariant)) && (
