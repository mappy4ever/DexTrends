...
// Helper functions
export function getGymLeaderImage(name, index = 1) {
...
export function getEliteFourImage(name, index = 1) {
...
export function getChampionImage(name, index = 1) {
...
export function getBadgeImage(badgeName, region) {
...
export function getGameCoverArt(gameName) {
...
// Get game logo path
export function getGameLogo(gameName) {
