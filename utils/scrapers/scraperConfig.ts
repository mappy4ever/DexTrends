...
// Type definitions for scraper configuration
interface BulbapediaUrls {
  baseUrl: string;
  wikiUrl: string;
  apiUrl: string;
  imageUrl: string;
...
interface RegionPages {
  pages: string[];
}

interface GymLeaderTargets {
  kanto: RegionPages;
  johto: RegionPages;
  hoenn: RegionPages;
  sinnoh: RegionPages;
...
interface PokemonTargets {
  starters: string[];
}

interface ScraperTargets {
  gymLeaders: GymLeaderTargets;
  games: GameTargets;
  badges: BadgeTargets;
  eliteFour: EliteFourTargets;
  champions: ChampionTargets;
  regionMaps: RegionMapTargets;
  pokemon: PokemonTargets;
}
...
interface ScraperConfig {
  bulbapedia: BulbapediaUrls;
  storage: StoragePaths;
  targets: ScraperTargets;
