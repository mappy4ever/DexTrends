 ...
 */
export const containsXSS = (input: any): boolean => {
 ...
 */
export const isValidLength = (str: any, min: number = 0, max: number = Infinity): boolean => {
 ...
 */
export const isAlphanumeric = (str: any): boolean => {
  if (typeof str !== 'string') return false;
