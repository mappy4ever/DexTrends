...
// Separate test file for multi-device testing
// Each device needs to be in its own describe block at the top level
// or have test.use() at the file level

// iPhone SE tests
test.describe('iPhone SE Protection @mobile-se', () => {
...
// iPhone 12 tests
test.describe('iPhone 12 Protection @mobile-12', () => {
...
// Pixel 5 tests
test.describe('Pixel 5 Protection @mobile-pixel', () => {
